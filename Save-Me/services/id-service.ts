...
class IdService {
    ...
    static readonly expensePageDeleteExpenseId: string = "expense-page-delete-expense";
    static readonly expensePageSelectId: string = "expense-page-select-type";
    ...
    static readonly newExpensePageCommentsId: string = "new-expense-page-comments";
    ...
    static readonly barLineAnimatedTabId: string = "bar-line-animated-tab";
